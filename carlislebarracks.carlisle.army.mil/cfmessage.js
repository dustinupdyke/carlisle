...
m['ajax.sendmessage-1.get.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/ajax.sendmessage.get*/]='HTTP GET {0}'
m['ajax.sendmessage-1.post.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/ajax.sendmessage.post*/]='HTTP POST {0} , params: {1}'
...
m['grid.init.toolbar.page.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/grid.init.toolbar.page*/]='Page'
m['grid.init.toolbar.of.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/grid.init.toolbar.of*/]='of {0}'
...
m['grid.fireselectionchangeevent.fire.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/grid.fireselectionchangeevent.fire*/]='Firing selection change event for grid id: {0}'
...
m['layout.hidetab.hide.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/layout.hidetab.hide*/]='Hide tab, id: {0} in tab container, id: {1}'
m['layout.hidetab.notfound']='ColdFusion.Layout.hideTab: Tab layout not found, id: {0}'
m['layout.showtab.show.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/layout.showtab.show*/]='Show tab, id: {0} in tab container, id: {1}'
...
m['tree.fireselectionchangeevent.fire.htm'/*tpa=http://carlislebarracks.carlisle.army.mil/cf_scripts/scripts/ajax/messages/tree.fireselectionchangeevent.fire*/]='Firing selection change event for tree id: {0}'
